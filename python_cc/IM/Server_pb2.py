...
_IMVALIDATEREQ = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='client_type', full_name='IM.Server.IMValidateReq.client_type', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='client_version', full_name='IM.Server.IMValidateReq.client_version', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attach_data', full_name='IM.Server.IMValidateReq.attach_data', index=4,
...
_IMGETDEVICETOKENREQ = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='group_id', full_name='IM.Server.IMGetDeviceTokenReq.group_id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attach_data', full_name='IM.Server.IMGetDeviceTokenReq.attach_data', index=2,
      number=20, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMUSERSTATUSUPDATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='identity', full_name='IM.Server.IMUserStatusUpdate.identity', index=3,
      number=4, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMPUSHTOUSERREQ = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user_token_list', full_name='IM.Server.IMPushToUserReq.user_token_list', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='notify_type', full_name='IM.Server.IMPushToUserReq.notify_type', index=1,
      number=2, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='attach_data', full_name='IM.Server.IMPushToUserReq.attach_data', index=2,
...
_IMCONSULTTIMEOUTCHECK = _descriptor.Descriptor(
  name='IMConsultTimeoutCheck',
  full_name='IM.Server.IMConsultTimeoutCheck',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_IMCONSULTTIMEOUTCHECKACK = _descriptor.Descriptor(
  name='IMConsultTimeoutCheckAck',
  full_name='IM.Server.IMConsultTimeoutCheckAck',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='consult_timeout_list', full_name='IM.Server.IMConsultTimeoutCheckAck.consult_timeout_list', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='result', full_name='IM.Server.IMConsultTimeoutCheckAck.result', index=1,
      number=2, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMCONSULTTIMEOUTCHECKACK.fields_by_name['consult_timeout_list'].message_type = IM.BaseDefine_pb2._CONSULTTIMEOUT
...
DESCRIPTOR.message_types_by_name['IMConsultTimeoutCheck'] = _IMCONSULTTIMEOUTCHECK
DESCRIPTOR.message_types_by_name['IMConsultTimeoutCheckAck'] = _IMCONSULTTIMEOUTCHECKACK
...
IMConsultTimeoutCheck = _reflection.GeneratedProtocolMessageType('IMConsultTimeoutCheck', (_message.Message,), dict(
  DESCRIPTOR = _IMCONSULTTIMEOUTCHECK,
  __module__ = 'IM.Server_pb2'
  # @@protoc_insertion_point(class_scope:IM.Server.IMConsultTimeoutCheck)
  ))
_sym_db.RegisterMessage(IMConsultTimeoutCheck)

IMConsultTimeoutCheckAck = _reflection.GeneratedProtocolMessageType('IMConsultTimeoutCheckAck', (_message.Message,), dict(
  DESCRIPTOR = _IMCONSULTTIMEOUTCHECKACK,
  __module__ = 'IM.Server_pb2'
  # @@protoc_insertion_point(class_scope:IM.Server.IMConsultTimeoutCheckAck)
  ))
_sym_db.RegisterMessage(IMConsultTimeoutCheckAck)
